...
export type tSerchSectionPropsRtnFunc = {
        レシピ名 : string,
        生成アイテム : string[]
    } | undefined;
...
export type tSerchSectionProps = {
    rtnFunc : (rtnFuncProp:tSerchSectionPropsRtnFunc) => void
}

export const SerchSection:React.FC<tSerchSectionProps> = (props) => {
    const [seriesObj,setSeriesObj] = useState<moecost.JSON.seriesCreationItems | undefined>(undefined);
